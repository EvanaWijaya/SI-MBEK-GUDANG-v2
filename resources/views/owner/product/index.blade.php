                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                        @foreach ($products as $p)
                                                <tr>
                                                    ...
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 uppercase">{{ $p->category }}
                                                    </td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        <span
                                                            ...
                                                            {{ [
                                                                'production' => 'Produksi',
                                                                'purchase' => 'Pembelian'
                                                            ][$p->source] ?? ucfirst($p->source) }}
                                                        </span>
                                                    </td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                                        Rp{{ number_format($p->selling_price, 0, ',', '.') }}</td>
                                                    <td class="whitespace-nowrap px-3 py-4 text-sm flex gap-2">
                                                        <a href="{{ route('owner.products.update', $p->id) }}"
