...
<div class="p-6 max-w-7xl mx-auto">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6 no-print">
        <form method="GET" action="{{ route('owner.report.monthly') }}" class="flex flex-wrap items-center gap-3">
            <div>
    ...
    <div class="no-print grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <h3 class="text-sm font-semibold text-gray-700 mb-4">Produksi & Pembuangan per {{ $mode == 'monthly' ? 'Bulan' : 'Tahun' }}</h3>
            <div class="h-56">
