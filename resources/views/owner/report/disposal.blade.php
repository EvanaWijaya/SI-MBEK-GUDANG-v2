...
<div class="p-6 max-w-7xl mx-auto">
    ...
    @include('owner.report._nav', ['active' => 'disposal'])

    {{-- ── Filter ── --}}
    <form method="GET" action="{{ route('owner.report.disposal') }}"
        ...
        <div class="flex flex-wrap items-end gap-3">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('owner.report.disposal') }}" class="px-3 py-2 text-sm text-gray-400 hover:text-gray-700 rounded-lg hover:bg-gray-100 transition-colors">Reset</a>
            </div>
        </div>
    </form>
