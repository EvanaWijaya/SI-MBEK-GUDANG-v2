<x-owner-app-layout>
    <div class="p-6 max-w-6xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-8">
            <a href="{{ route('owner.material.index') }}"
        ...
        <div class="space-y-6">
                    ...
                    <div
                        ...
                        <div class="flex items-baseline gap-2 mt-2">
                            <p class="text-4xl font-bold {{ $belowRop ? 'text-red-600' : 'text-gray-800' }}">
                                {{ number_format($material->stock) }}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <dl class="space-y-3 text-sm">
                        ...
                        <div class="flex justify-between">
                            ...
                            <dd class="font-medium text-gray-700">Rp
                                {{ number_format($material->average_price, 0, ',', '.') }}</dd>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                    ...
                    <form method="POST" action="{{ route('owner.inventory.material.sync', $material->id) }}"
                        class="mt-4">
