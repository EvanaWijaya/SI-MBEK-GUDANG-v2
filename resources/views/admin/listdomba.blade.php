<x-admin-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-10" x-data="{ open: false, kambing: null }">
        ...
        <button class="mt-8 bg-brand-orange hover:bg-orange-700 p-3 rounded-md mb-2 text-white"><a
                href="{{ route('admin.tambahdomba') }}">Tambah Domba</a></button>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            class="text-sm text-gray-500  uppercase justify-center text-center
                                             @if ($db->for_sale === 'yes') bg-green-500 text-white
                                             @elseif($db->for_sale === 'no') bg-red-500 text-white @endif">
                                            {{ $db->for_sale }}
                                        </td>

                                        </td>
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 sm:pl-6">
                                            {{ $db->created_at->format('Y-m-d') }}
                                        </td>
                                        ...
                                        <td class="whitespace-nowrap py-4 text-sm text-gray-500 px-2   ">
                                            ...
                                            <button type="button"
                                                onclick="openModal('deleteModal-{{ $db->id }}')"
                                            ...
                                            <div id="deleteModal-{{ $db->id }}"
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-end">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('admin.domba.destroy', $db->id) }}"
        ...
        {{-- <div x-show="open" id="poin"
            ...
            <div class="bg-white p-4 rounded-lg w-1/3 max-h-screen overflow-y-auto">
                <h2 class="text-xl font-bold mb-4">Edit Domba</h2>
                <form method="POST" :action="'{{ route('admin.kambings.update', '') }}/' + kambing.id"
                    enctype="multipart/form-data">

                    @csrf
                    @method('PUT')
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Nama Domba</label>
