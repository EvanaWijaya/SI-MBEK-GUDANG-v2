                            ...
                            <ul class="space-y-2 pb-2 ">
                                ...
                                <li class="flex">
                                    <a href="#"
                                        ...
                                        <x-responsive-nav-link :href="route('admin.tambahkambing')" :active="request()->routeIs('admin.tambahkambing')">
                                            {{ __('Tambah Kambing') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li>
                                ...
                                <li class="flex">
                                    <a href="#"
                                        ...
                                        <x-responsive-nav-link :href="route('admin.listkambing')" :active="request()->routeIs('admin.listkambing')">
                                            {{ __('List Kambing') }}
                                        </x-responsive-nav-link>
                                    </a>
                                </li>
