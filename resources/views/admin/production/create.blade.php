<x-admin-app-layout>
    <div class="p-6 max-w-2xl mx-auto">
        ...
        @if($errors->any())
            <div
                class="mb-6 flex items-start gap-3 bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-lg text-sm shadow-sm">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="mb-6 bg-orange-50 border border-orange-100 rounded-lg px-4 py-3 text-xs text-orange-700">
                ...
                <div class="flex items-center gap-2 flex-wrap">
                    <span
                        class="inline-flex items-center gap-1 bg-yellow-100 text-yellow-700 px-2 py-0.5 rounded-full font-medium">1.
                        Buat Produksi</span>
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <span
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-gray-400">kg</span>
                        </div>
            ...
            function loadProducts(formulaId, selectedProductId = null) {
                ...
                if (products.length === 0) {
                    ...
                    products.forEach(p => {
                        ...
                        select.innerHTML += `<option value="${p.id}" ${isSelected}>[${p.product_code}] ${p.product_name}</option>`;
                    });
                }
            ...
            function hitungKebutuhanKg(formulaId = null) {
                ...
                if (materials.length > 0) {
                    list.innerHTML = materials.map(m => {
                        let hitungKg = (parseFloat(m.percentage) / 100) * totalProduksi;
                    ...
                    <div class="flex justify-between items-center px-4 py-2.5 text-xs bg-white hover:bg-gray-50/50 transition-colors">
                        <span class="text-gray-700 font-medium">${m.material_name} <span class="text-gray-400 font-normal">(${m.percentage}%)</span></span>
