<x-admin-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight">{{ __('Admin - Master Bahan Pakan') }}</h2>
    </x-slot>

    <div class="px-4 sm:px-6 lg:px-8 mt-10">
        <button class="mt-8 bg-brand-orange hover:bg-orange-700 p-3 rounded-md mb-2 text-white">
            <a href="{{ route('admin.materials.create') }}">Tambah Material Pakan</a>
        </button>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            sortSelect.addEventListener('change', function() {
                ...
                if (sortBy === 'terbaru') {
                    ...
                    rowsArray.sort((a, b) => {
                        // Ambil teks dari kolom pertama (Nama Bahan)
