            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        {{-- Supplier --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Supplier <span
                        ...
                        {{-- Tipe PO --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Tipe PO <span
                                    class="text-red-500">*</span></label>
                        ...
                        {{-- Tanggal Pesan --}}
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1.5">Tanggal Pesan <span
                                    class="text-red-500">*</span></label>
                                    ...
                                    <div class="flex gap-4 p-2.5 bg-gray-50 rounded-lg border border-gray-200">
                                        <label class="flex items-center gap-2 cursor-pointer group">
                                            <input type="radio" name="dipesan_oleh_type" value="Admin"
                                                class="text-orange-500 focus:ring-orange-400" checked
                                        ...
                                        <label class="flex items-center gap-2 cursor-pointer group">
                                            <input type="radio" name="dipesan_oleh_type" value="Owner"
                                                ...
                                                onchange="toggleOwnerSelect(true)">
                                            <span class="text-sm text-gray-700 group-hover:text-gray-900">Owner</span>
                                        </label>
                                    </div>
                                </div>

                                {{-- Dropdown Pilih Owner (Muncul hanya jika radio Owner dipilih) --}}
                                <div id="owner-select-wrap"
                                    class="{{ old('dipesan_oleh_type') === 'Owner' ? '' : 'hidden' }}">
                                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Pilih Nama Owner <span
                                            class="text-red-500">*</span></label>
                                    <select name="dipesan_oleh_id" id="dipesan_oleh_id"
                                        class="w-full border border-gray-300 rounded-lg px-3 py-2.5 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition">
                                        <option value="">-- Pilih Owner --</option>
                                        @foreach(App\Models\Owner::all() as $owner)
                                            <option value="{{ $owner->id }}" {{ old('dipesan_oleh_id') == $owner->id ? 'selected' : '' }}>
                                                {{ $owner->name }}
                                            </option>
                                        @endforeach
                                    </select>
    ...
    @push('scripts')
        <script>
            ...
            function addItem() {
                ...
                row.innerHTML = `
                    ...
                    <div class="col-span-8 sm:col-span-4">
                        ...
                        <input type="text" name="items[${idx}][harga_satuan]" placeholder="Rp 0" required
                            oninput="formatRupiah(this); calcRow(${idx})"
                            class="w-full border border-gray-300 bg-white rounded-lg px-3 py-2 text-sm">
                    </div>
            ...
            function calcRow(idx) {
                ...
                const priceInput = row.querySelector(`[name="items[${idx}][harga_satuan]"]`).value;
