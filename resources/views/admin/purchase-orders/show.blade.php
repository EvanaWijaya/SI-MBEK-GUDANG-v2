        ...
        <div class="space-y-6">
            ...
            @if(auth()->guard('admin')->check() && $purchaseOrder->status === 'ordered')
                <div class="bg-white rounded-xl border border-blue-200 shadow-sm overflow-hidden">
                    ...
                    <form method="POST" novalidate action="{{ route('admin.purchase-orders.receive', $purchaseOrder->id) }}"
                        id="receive-form">
                        @csrf
                                ...
                                <thead class="border-b border-gray-100">
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            Pesan</th>
                                        <th
                                            class="pb-3 text-center font-semibold text-gray-600 text-xs uppercase tracking-wide w-32">
                                            Diterima</th>
                                        <th
                                            class="pb-3 text-center font-semibold text-gray-600 text-xs uppercase tracking-wide w-48">
                                            Expired Date</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-50">
