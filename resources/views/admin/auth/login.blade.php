<x-admin-guest-layout>
    ...
    <form method="POST" action="{{ route('admin.login') }}">
        ...
        <div>
            ...
            <x-text-input
                id="email"
                class="block mt-1 w-full border-[#E28700] focus:ring-orange-400 focus:border-orange-400"
                type="email"
                name="email"
                :value="old('email')"
                required
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input
                    id="remember_me"
                    type="checkbox"
                    class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-orange-500"
                    name="remember"
                >
