                        ...
                        @foreach($recentActivities as $log)
                            @php
                                $iconCfg = match(true) {
                                    ...
                                    str_contains($log->category, 'order_')      => ['bg'=>'bg-green-50', 'text'=>'text-green-500',  'icon'=>'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014
                                    str_contains($log->category, 'disposal_')   => ['bg'=>'bg-red-5<PASSWORD>',   'text'=>'text-red-4<PASSWORD>',   'icon'=>'M19 
                                    str_contains($log->category, 'qc_')         => ['bg'=>'bg-yellow-5<PASSWORD>','text'=>'text-yellow-5<PASSWORD>','icon'=>'M9 
                                    default                                 => ['bg'=>'bg-gray-5<PASSWORD>',  'text'=>'text-gray-4<PASSWORD>',  
