            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden border border-gray-200">
                <div class="p-6 bg-brand-orange text-white flex justify-between items-center">
                    ...
                    <div class="flex gap-2 text-black">
                        ...
                        <button type="submit" x-show="editMode" class="bg-white text-brand-orange px-4 py-1 rounded text-sm font-bold shadow">Simpan Perubahan</button>
                        <a href="{{ route('admin.suppliers.index') }}" x-show="!editMode" class="bg-white text-brand-orange px-4 py-1 rounded text-sm font-bold shadow">Kembali</a>
                    </div>
                </div>
