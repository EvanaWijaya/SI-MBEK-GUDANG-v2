<x-admin-app-layout>
    ...
    <div class="px-4 sm:px-6 lg:px-8 mt-10" x-data="{ open: false, kambing: null }">
        ...
        <button class="mt-8 bg-brand-orange hover:bg-orange-700 p-3 rounded-md mb-2 text-white">
            <a href="{{ route('admin.tambahkambing') }}">Tambah Kambing</a>
        </button>
                                ...
                                @foreach ($kambings as $kb)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap py-4 text-sm text-gray-500 px-2 flex justify-center gap-2 items-center h-full mt-2 border-none">
                                            <a href="{{ route('admin.kambing.show', $kb->id) }}">
                                            ...
                                            <button type="button" onclick="openModal('deleteModal-{{ $kb->id }}')"
                                            ...
                                            <div id="deleteModal-{{ $kb->id }}" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
                                                <div class="bg-white rounded-lg overflow-hidden shadow-xl max-w-sm w-full p-6 text-center">
                                                    ...
                                                    <p class="mb-6 text-gray-600 whitespace-normal">Apakah Anda yakin ingin menghapus <b>{{ $kb->name }}</b>?</p>
                                                    <div class="flex justify-center gap-3">
                                                        ...
                                                        <form method="POST" action="{{ route('admin.kambing.destroy', $kb->id) }}">
                                                            @csrf
                                                            @method('delete')
