...
class ReportController extends Controller
{
    ...
    public function monthly(Request $request)
    {
        ...
        if ($mode === 'annual') {
            ...
            return view('owner.report.monthly', compact('mode', 'dataList', 'totals', 'year', 'availableYears', 'startYear', 'endYear'));
            ...
            return view('owner.report.monthly', compact('mode', 'dataList', 'totals', 'year', 'availableYears'));
        }
    }
}